...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		/*bf = new FlxSprite();
		bf.frames = Paths.getSparrowAtlas('characters/BoyFriend_SusGun', 'shared');
		...
		for (i in 0...optionShit.length)
		{
			...
			switch(i)
				{
					case 0:
						menuItem.setPosition(58.75, 19);
					case 1:
						menuItem.setPosition(48.1, 196.4);
					case 2:
						menuItem.setPosition(76.95, 393.65);
					case 3:
						menuItem.setPosition(182.25, 557.5);
				}
